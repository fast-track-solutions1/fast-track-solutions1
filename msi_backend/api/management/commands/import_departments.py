...
class Command(BaseCommand):
    help = "Importe tous les 101 departements francais dans la base de donnees"
    ...
    DEPARTEMENTS = [
        ...
        (7, "Ard?che", "Privas", "Auvergne-Rhone-Alpes"),
        ...
        (38, "Is?re", "Grenoble", "Auvergne-Rhone-Alpes"),
        ...
        (58, "Ni?vre", "Nevers", "Bourgogne-Franche-Comte"),
