# ============================================================================
# ✅ FICHIER VIEWS.PY CORRIGÉ - PERMISSIONS ÉQUIPEMENTS FIXES
# ============================================================================
...
class EquipementInstanceViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [IsAuthenticated, CanViewSalaries]  # ✅ CORRIGÉ!
